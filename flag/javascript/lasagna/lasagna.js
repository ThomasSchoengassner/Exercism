...
export function preparationTimeInMinutes(numberOfLayers) {
  var preparation_time = numberOfLayers * 2;
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  var total_time = preparationTimeInMinutes(numberOfLayers) + actualMinutesInOven;
  console.log('total working time: %d', total_time)
